...
# Function for if accelerometer is tilted far to the right or to the left.
def tilt_detected():
...
class Ship(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.rect.move_ip(convert_movement(regXa, regXb), 0)

        self.reload_timer += 1
        if (Z_movement_detected()) and not self.overheated:
            self.heat += 2
...
class Game:
    ...
    def menuLoop(self):
        ...
        while 1:
            ...
            newY = convert_movement(regYa, regYb)
