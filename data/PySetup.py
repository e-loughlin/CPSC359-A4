...
script = "Invasion of the Blobs.pyw"  # Starting .py or .pyw script
dest_file = "Invasion of the Blobs"   # Final name of .exe file
dest_folder = "Invasion of the Blobs" # Final folder for the files
